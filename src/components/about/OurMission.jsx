...
const OurMission = () => {
  return (
    <div className=' flex flex-col bg-[#22222292] p-5 rounded-md md:flex-row md:items-center justify-between w-[90%] mx-auto md:mt-32 mt-12'>
      <MetaTags title="OUR MISSION" description="With years of industry experience, our mission is to empower startups, SMEs, and enterprises with cutting-edge technology and creative digital strategies that drive measurable growth. From building intuitive mobile applications to crafting user-friendly websites and executing high-converting marketing campaigns, we bring a holistic approach to every project." />
