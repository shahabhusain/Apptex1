...
const Hero = () => {
  return (
    <div className='relative w-full flex flex-col items-center justify-center px-4 md:px-12 text-white'>

      <MetaTags title="We help Build, Scale, Accelerate, Transform digital solutions" description="Custom Mobile Apps • Responsive Websites • Growth-Driven Marketing" />
